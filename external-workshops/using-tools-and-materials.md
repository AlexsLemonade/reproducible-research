...
<img src="screenshots/reproducible-research-fork-1.png" width=800>
...
<img src="screenshots/rrp-exercises-fork-1.png" width=800>

* Make sure you are the owner of the new repository and click `Create Fork`.
<img src="screenshots/rrp-exercises-fork-2.png" width=800>

After forking each of the repositories, you can interact with the materials on your GitHub account, but we recommend that you also clone your new repositories to your own computer using the command line or a GUI! 
